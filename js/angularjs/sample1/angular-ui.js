        ...
        if (controller != null) {
          updateModel = function(value, picker) {
            return $scope.$apply(function() {
              return controller.$setViewValue(element.datetimepicker("getDate"));
            });
          };
          ...
          controller.$render = function() {
            originalRender();
            return element.datetimepicker("setDate", controller.$viewValue);
          };
        }
        return element.datetimepicker($scope.uiDate);
      }
    };
  });
